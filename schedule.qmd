...
-   [**Lab activities**](/reading/index.html)
    (<i class="fas fa-users"></i>): This page is about labs

-   [**Reading**](/Extras/index.html) (<i class="fas fa-bookmark"></i>):
    This page is about Extras

-   [**Mini-Diss**](/Mini-Diss/index.html)
    (<i class="fas fa-book"></i>): This page contains an interactive
    lesson that teaches you the principles and code you need to know. Go
    through these after doing the content.
...
d |>
  ...
  cols_align(align = "center", columns = c(week, date, prepare, lecture, lab, reading, minidiss)) |>
  ...
  tab_style(
    ...
    locations = cells_body(
      columns = c(week, date, topic, prepare, lecture, lab, reading, minidiss)
    )
  ) |>
  ...
  tab_style(
    ...
    locations = cells_body(
      columns = c(prepare, lecture, lab, reading, minidiss)
    )
  ) |>
