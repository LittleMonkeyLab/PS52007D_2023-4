...
d |>
  ...
  cols_align(align = "center", columns = c(week, date, overview, lecture, lab, reading, minidiss)) |>
  ...
  tab_style(
    ...
    locations = cells_body(
      columns = c(week, date, topic, overview, lecture, lab, reading, minidiss)
    )
  ) |>
  ...
  tab_style(
    ...
    locations = cells_body(
      columns = c(overview, lecture, lab, reading, minidiss)
    )
  ) |>
