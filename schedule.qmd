...
-   **Overview** (<i class="fas fa-binoculars"></i>): This page
    overviews the weeks

-   **Lecture slides** (<i class="fas fa-tv"></i>): This page is for
    lectures

-   **Lab slides** (<i class="fas fa-users"></i>): This page is about
    labs

-   **Worksheets** (<i class="fas fa-pencil-ruler"></i>): This page is
    about labs

-   **DangerZone** (<i class="fas fa-book"></i>): This page is about
    Extras
