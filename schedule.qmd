...
Here's your roadmap for the year! Pay attention!
...
-   [Lab slides](/slides/index.html) (<i class="fas fa-users"></i>):
    This page is about labs

-   [**Reading**](/reading/index.html)
    (<i class="fas fa-bookmark"></i>): This page is about Extras

-   [**Mini-Diss**](/minidiss/index.html) (<i class="fas fa-book"></i>):
    This page contains an interactive lesson that teaches you the
    principles and code you need to know. Go through these after doing
    the content.
...
-   Attend the lab (<i class="fas fa-users"></i>) and get cracking
-   Use the plentiful Mini-Diss resources (<i class="fas fa-book"></i>)
    to help you smash the MD
:::
:::
:::
:::
...
d |>
  ...
  text_transform(cells_body(columns = c(lecture)), fn = conditional_transform_fn("person-chalkboard")) |>
  text_transform(cells_body(columns = c(lab)), fn = conditional_transform_fn("users")) |>
  text_transform(cells_body(columns = c(worksheet)), fn = conditional_transform_fn("pen-ruler")) |>
  ...
  cols_align(align = "center", columns = c(week, date, overview, lecture, lab, worksheet, reading, minidiss)) |>
  ...
  tab_style(
    ...
    locations = cells_body(
      columns = c(week, date, topic, overview, lecture, lab, worksheet, reading, minidiss)
    )
  ) |>
  ...
  tab_style(
    ...
    locations = cells_body(
      columns = c(overview, lecture, lab, worksheet, reading, minidiss)
    )
  ) |>
